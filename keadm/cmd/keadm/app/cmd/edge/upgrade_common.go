...
func (executor *baseUpgradeExecutor) prePrerun(configpath string) error {
	...
	if occupied {
		return errors.New("the mutually exclusive command is being executed")
	}
