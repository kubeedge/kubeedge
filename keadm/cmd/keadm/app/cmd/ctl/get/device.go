...
func (o *DeviceGetOptions) getDevices(args []string) error {
	...
	o.PrintFlags.SetKind(v1beta1.SchemeGroupVersion.WithKind("Device").GroupKind())
	...
	deviceObjectList.GetObjectKind().SetGroupVersionKind(v1beta1.SchemeGroupVersion.WithKind("Device"))
...
func AddGetDeviceFlags(cmd *cobra.Command, deviceGetOptions *DeviceGetOptions) {
	...
	// TODO: There are some errors in the output results of yaml and json formats, which need to be improved.
