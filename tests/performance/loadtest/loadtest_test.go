...
var _ = Describe("Application deployment test in Perfronace test EdgeNodes", func() {
	...
	Context("Test application deployment on Kubeedge EdgeNodes", func() {
		...
		Measure("MEASURE_PERF_NODETEST_NODES_10: Create 10 KubeEdge Node Deployment, Measure Node Ready time", func(b Benchmarker) {
			podlist = metav1.PodList{}
			runtime := b.Time("runtime", func() {
				var deploymentList v1.DeploymentList
				podlist = metav1.PodList{}
		...
		Measure("MEASURE_PERF_NODETEST_NODES_50: Create 50 KubeEdge Node Deployment, Measure Node Ready time", func(b Benchmarker) {
			podlist = metav1.PodList{}
			runtime := b.Time("runtime", func() {
				var deploymentList v1.DeploymentList
				podlist = metav1.PodList{}
		...
		Measure("MEASURE_PERF_NODETEST_NODES_75: Create 75 KubeEdge Node Deployment, Measure Node Ready time", func(b Benchmarker) {
			podlist = metav1.PodList{}
			runtime := b.Time("runtime", func() {
				var deploymentList v1.DeploymentList
				podlist = metav1.PodList{}
		...
		Measure("MEASURE_PERF_NODETEST_NODES_100: Create 100 KubeEdge Node Deployment, Measure Node Ready time", func(b Benchmarker) {
			podlist = metav1.PodList{}
			runtime := b.Time("runtime", func() {
				var deploymentList v1.DeploymentList
				podlist = metav1.PodList{}
