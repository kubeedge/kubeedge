...
// shouldUseEdgeTunnelIP mirrors cloudstream.TunnelServer.shouldUseEdgeTunnelIP:
// this gates every heartbeat patch, that gates the initial connect-time
// write, and the two must not disagree.
