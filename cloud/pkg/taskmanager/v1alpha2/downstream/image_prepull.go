...
func (h *ImagePrePullJobHandler) CanDownstreamStatus(obj any, _isInInitialList bool) bool {
...
func (h *ImagePrePullJobHandler) HandleNodeActionError(
	ctx context.Context,
	job wrap.NodeJob,
	...
	nodeTaskStatus, ok := errTask.GetObject().(*operationsv1alpha2.ImagePrePullNodeTaskStatus)
	if !ok {
