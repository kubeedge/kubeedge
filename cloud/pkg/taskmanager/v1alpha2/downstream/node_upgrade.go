...
func (h *NodeUpgradeJobHandler) CanDownstreamPhase(obj any, _isInInitialList bool) bool {
...
func (h *NodeUpgradeJobHandler) UpdateNodeTaskStatus(
	...
	nodeTaskStatus, ok := task.GetObject().(*operationsv1alpha2.NodeUpgradeJobNodeTaskStatus)
	if !ok {
