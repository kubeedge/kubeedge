...
func (task ImagePrePullJobTask) Status() operationsv1alpha2.NodeTaskStatus {
	return task.Obj.Status
}

func (task *ImagePrePullJobTask) SetStatus(status operationsv1alpha2.NodeTaskStatus) {
