...
// Manager define the interface of a Manager, Upgrade Manager implement it
type Manager interface {
	Events() chan watch.Event
}

// CommonResourceEventHandler can be used by Upgrade Manager
...
// NewCommonResourceEventHandler create CommonResourceEventHandler used by Upgrade Manager
