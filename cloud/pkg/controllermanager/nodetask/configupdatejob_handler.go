...
func (ConfigUpdateJobReconcileHandler) GetResource() string {
...
func (ConfigUpdateJobReconcileHandler) NoFinalizer(job *operationsv1alpha2.ConfigUpdateJob) bool {
	return !controllerutil.ContainsFinalizer(job, operationsv1alpha2.FinalizerConfigUpdateJob)
}

func (h *ConfigUpdateJobReconcileHandler) AddFinalizer(ctx context.Context, job *operationsv1alpha2.ConfigUpdateJob) error {
	newOne := job.DeepCopy()
	controllerutil.AddFinalizer(newOne, operationsv1alpha2.FinalizerConfigUpdateJob)
	return h.cli.Patch(ctx, newOne, client.MergeFrom(job))
}

func (h *ConfigUpdateJobReconcileHandler) RemoveFinalizer(ctx context.Context, job *operationsv1alpha2.ConfigUpdateJob) error {
	newOne := job.DeepCopy()
	controllerutil.RemoveFinalizer(newOne, operationsv1alpha2.FinalizerConfigUpdateJob)
	return h.cli.Patch(ctx, newOne, client.MergeFrom(job))
}
...
func (ConfigUpdateJobReconcileHandler) IsDeleted(job *operationsv1alpha2.ConfigUpdateJob) bool {
...
func (h *ConfigUpdateJobReconcileHandler) CheckTimeout(ctx context.Context, jobName string) error {
