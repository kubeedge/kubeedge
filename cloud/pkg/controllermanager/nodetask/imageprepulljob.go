...
func NewImagePrePullJobController(client client.Client) *ImagePrePullJobController {
...
func (c *ImagePrePullJobController) Reconcile(ctx context.Context, req controllerruntime.Request,
	...
	if err = c.Get(ctx, req.NamespacedName, &job); err != nil {
...
func (c *ImagePrePullJobController) SetupWithManager(ctx context.Context, mgr controllerruntime.Manager) error {
