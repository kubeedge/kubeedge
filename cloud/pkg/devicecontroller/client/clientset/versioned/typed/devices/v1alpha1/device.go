...
import (
	...
	scheme "github.com/kubeedge/kubeedge/cloud/pkg/devicecontroller/client/clientset/versioned/scheme"
...
type DeviceInterface interface {
	...
	Update(*v1alpha1.Device) (*v1alpha1.Device, error)
	UpdateStatus(*v1alpha1.Device) (*v1alpha1.Device, error)
...
func newDevices(c *DevicesV1alpha1Client, namespace string) *devices {
	return &devices{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *devices) Get(name string, options v1.GetOptions) (result *v1alpha1.Device, err error) {
...
func (c *devices) List(opts v1.ListOptions) (result *v1alpha1.DeviceList, err error) {
...
func (c *devices) Create(device *v1alpha1.Device) (result *v1alpha1.Device, err error) {
	result = &v1alpha1.Device{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("devices").
...
func (c *devices) Update(device *v1alpha1.Device) (result *v1alpha1.Device, err error) {
	result = &v1alpha1.Device{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devices").
...
func (c *devices) UpdateStatus(device *v1alpha1.Device) (result *v1alpha1.Device, err error) {
	result = &v1alpha1.Device{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devices").
...
func (c *devices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Device, err error) {
	result = &v1alpha1.Device{}
