	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DevicesV1alpha1().Devices(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DevicesV1alpha1().Devices(namespace).Watch(options)
			},
		},
		&devicesv1alpha1.Device{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *deviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&devicesv1alpha1.Device{}, f.defaultInformer)
}
