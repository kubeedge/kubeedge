...
import (
	...
	devicesv1alpha1 "github.com/kubeedge/kubeedge/cloud/pkg/devicecontroller/apis/devices/v1alpha1"
	versioned "github.com/kubeedge/kubeedge/cloud/pkg/devicecontroller/client/clientset/versioned"
	internalinterfaces "github.com/kubeedge/kubeedge/cloud/pkg/devicecontroller/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kubeedge/kubeedge/cloud/pkg/devicecontroller/client/listers/devices/v1alpha1"
...
type DeviceModelInformer interface {
	...
	Lister() v1alpha1.DeviceModelLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			...
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				...
				return client.DevicesV1alpha1().DeviceModels(namespace).Watch(options)
			},
		},
		&devicesv1alpha1.DeviceModel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *deviceModelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&devicesv1alpha1.DeviceModel{}, f.defaultInformer)
}

func (f *deviceModelInformer) Lister() v1alpha1.DeviceModelLister {
	return v1alpha1.NewDeviceModelLister(f.Informer().GetIndexer())
}
