...
func admitRuleEndpoint(review admissionv1beta1.AdmissionReview) *admissionv1beta1.AdmissionResponse {
	...
	case admissionv1beta1.Create:
		...
		msg = validateRuleEndpoint(&ruleEndpoint, &reviewResponse)
...
func validateRuleEndpoint(ruleEndpoint *rulesv1.RuleEndpoint, response *admissionv1beta1.AdmissionResponse) string {
	var msg string
	ruleEndpointType := ruleEndpoint.Spec.RuleEndpointType
	if ruleEndpointType != "rest" && ruleEndpointType != "servicebus" && ruleEndpointType != "eventbus" {
		msg = "RuleEndpointType should be rest or eventbus or servicebus"
