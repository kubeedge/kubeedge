...
func (c *objectSyncs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ObjectSync, err error) {
...
func (c *objectSyncs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ObjectSyncList, err error) {
...
func (c *objectSyncs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *objectSyncs) Create(ctx context.Context, objectSync *v1alpha1.ObjectSync, opts v1.CreateOptions) (result *v1alpha1.ObjectSync, err error) {
	result = &v1alpha1.ObjectSync{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("objectsyncs").
...
func (c *objectSyncs) Update(ctx context.Context, objectSync *v1alpha1.ObjectSync, opts v1.UpdateOptions) (result *v1alpha1.ObjectSync, err error) {
	result = &v1alpha1.ObjectSync{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectsyncs").
...
func (c *objectSyncs) UpdateStatus(ctx context.Context, objectSync *v1alpha1.ObjectSync, opts v1.UpdateOptions) (result *v1alpha1.ObjectSync, err error) {
	result = &v1alpha1.ObjectSync{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectsyncs").
...
func (c *objectSyncs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *objectSyncs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *objectSyncs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ObjectSync, err error) {
	result = &v1alpha1.ObjectSync{}
