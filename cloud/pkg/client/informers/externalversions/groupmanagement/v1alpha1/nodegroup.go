	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GroupmanagementV1alpha1().NodeGroups().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupmanagementV1alpha1().NodeGroups().Watch(context.TODO(), options)
			},
		},
		&groupmanagementv1alpha1.NodeGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&groupmanagementv1alpha1.NodeGroup{}, f.defaultInformer)
}
