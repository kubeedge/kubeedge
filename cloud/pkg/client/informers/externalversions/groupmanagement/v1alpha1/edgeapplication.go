...
import (
	...
	v1alpha1 "github.com/kubeedge/kubeedge/cloud/pkg/client/listers/groupmanagement/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GroupmanagementV1alpha1().EdgeApplications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupmanagementV1alpha1().EdgeApplications(namespace).Watch(context.TODO(), options)
			},
		},
		&groupmanagementv1alpha1.EdgeApplication{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *edgeApplicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&groupmanagementv1alpha1.EdgeApplication{}, f.defaultInformer)
}
