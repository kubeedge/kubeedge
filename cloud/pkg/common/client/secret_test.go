			...
			reactors: []k8stesting.Reactor{
				&k8stesting.SimpleReactor{
					...
					Reaction: func(action k8stesting.Action) (handled bool, ret runtime.Object, err error) {
						return true, nil, fmt.Errorf("namespace creation error")
					},
				},
			},
			expectErr: true,
		},
		{
			...
			reactors: []k8stesting.Reactor{
				&k8stesting.SimpleReactor{
					...
					Resource: "secrets",
					Reaction: func(action k8stesting.Action) (handled bool, ret runtime.Object, err error) {
						return true, nil, fmt.Errorf("secret creation error")
					},
				},
			},
			expectErr: true,
		},
		{
			...
			reactors: []k8stesting.Reactor{
				&k8stesting.SimpleReactor{
					...
					Resource: "secrets",
					Reaction: func(action k8stesting.Action) (handled bool, ret runtime.Object, err error) {
						return true, nil, errors.NewAlreadyExists(schema.GroupResource{Resource: "secrets"}, "update-error-secret")
					},
				},
				&k8stesting.SimpleReactor{
					Verb:     "update",
					Resource: "secrets",
					Reaction: func(action k8stesting.Action) (handled bool, ret runtime.Object, err error) {
						return true, nil, fmt.Errorf("secret update error")
					},
				},
			},
			expectErr: true,
