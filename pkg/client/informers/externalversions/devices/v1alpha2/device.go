...
import (
	...
	v1alpha2 "github.com/kubeedge/kubeedge/pkg/client/listers/devices/v1alpha2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DevicesV1alpha2().Devices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DevicesV1alpha2().Devices(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *deviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&devicesv1alpha2.Device{}, f.defaultInformer)
}

func (f *deviceInformer) Lister() v1alpha2.DeviceLister {
	return v1alpha2.NewDeviceLister(f.Informer().GetIndexer())
}
