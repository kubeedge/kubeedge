...
type Interface interface {
	// EdgeApplications returns a EdgeApplicationInformer.
	EdgeApplications() EdgeApplicationInformer
...
// EdgeApplications returns a EdgeApplicationInformer.
func (v *version) EdgeApplications() EdgeApplicationInformer {
	return &edgeApplicationInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
