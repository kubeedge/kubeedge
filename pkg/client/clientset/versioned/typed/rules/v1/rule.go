...
func (c *rules) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Rule, err error) {
	result = &v1.Rule{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rules").
...
func (c *rules) List(ctx context.Context, opts metav1.ListOptions) (result *v1.RuleList, err error) {
...
func (c *rules) Create(ctx context.Context, rule *v1.Rule, opts metav1.CreateOptions) (result *v1.Rule, err error) {
	result = &v1.Rule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rules").
...
func (c *rules) Update(ctx context.Context, rule *v1.Rule, opts metav1.UpdateOptions) (result *v1.Rule, err error) {
	result = &v1.Rule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rules").
...
func (c *rules) UpdateStatus(ctx context.Context, rule *v1.Rule, opts metav1.UpdateOptions) (result *v1.Rule, err error) {
	result = &v1.Rule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rules").
...
func (c *rules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Rule, err error) {
	result = &v1.Rule{}
