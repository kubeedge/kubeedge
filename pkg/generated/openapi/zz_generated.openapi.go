...
// Code generated by openapi-gen.exe. DO NOT EDIT.
...
func schema_pkg_apis_devices_v1alpha2_VisitorConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "At least one of its members must be specified.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"opcua": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_rules_v1_RuleEndpointList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RuleEndpointList contains a list of RuleEndpoint",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_rules_v1_RuleEndpointSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "RuleEndpointSpec defines endpoint of rule.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"ruleEndpointType": {
						SchemaProps: spec.SchemaProps{
							Description: "RuleEndpointType defines type: servicebus, rest",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"properties": {
						SchemaProps: spec.SchemaProps{
							Description: "Properties: properties of endpoint. for example: servicebus: {\"service_port\":\"8080\"}",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
				...
				Required: []string{"ruleEndpointType"},
			},
		},
	}
}
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"source", "sourceResource", "target", "targetResource"},
			},
		},
	}
}
	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"successMessages", "failMessages", "errors"},
			},
		},
	}
}
