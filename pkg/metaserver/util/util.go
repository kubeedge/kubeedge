...
func UnsafeResourceToKind(r string) string {
	...
	unusualResourceToKind := map[string]string{
		...
		"ciliumnodelists":                  "CiliumNodeList",
		"ciliumendpoints":                  "CiliumEndpoint",
		"ciliumnetworkpolicies":            "CiliumNetworkPolicy",
		"ciliumclusterwidenetworkpolicies": "CiliumClusterwideNetworkPolicy",
		"ciliumidentities":                 "CiliumIdentity",
		"ciliumenvoyconfigs":               "CiliumEnvoyConfig",
		"ciliumclusterwideenvoyconfigs":    "CiliumClusterwideEnvoyConfig",
		"ciliumbgpadvertisements":          "CiliumBGPAdvertisement",
		"ciliumbgpclusterconfigs":          "CiliumBGPClusterConfig",
		"ciliumbgpnodeconfigs":             "CiliumBGPNodeConfig",
		"ciliumbgpnodeconfigoverrides":     "CiliumBGPNodeConfigOverride",
		"ciliumbgppeerconfigs":             "CiliumBGPPeerConfig",
		"ciliumcidrgroups":                 "CiliumCIDRGroup",
		"ciliumloadbalancerippools":        "CiliumLoadBalancerIPPool",
		"ciliumlocalredirectpolicies":      "CiliumLocalRedirectPolicy",
		"ciliumegressgatewaypolicies":      "CiliumEgressGatewayPolicy",
		"ciliumnodeconfigs":                "CiliumNodeConfig",
	}
...
func UnsafeKindToResource(k string) string {
	...
	unusualKindToResource := map[string]string{
		...
		"CiliumNodeList":                 "ciliumnodelists",
		...
		"CiliumEnvoyConfig":              "ciliumenvoyconfigs",
		"CiliumClusterwideEnvoyConfig":   "ciliumclusterwideenvoyconfigs",
		...
		"CiliumLocalRedirectPolicy":      "ciliumlocalredirectpolicies",
		"CiliumEgressGatewayPolicy":      "ciliumegressgatewaypolicies",
		"CiliumNodeConfig":               "ciliumnodeconfigs",
	}
