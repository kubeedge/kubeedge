...
func RenderOpenAPISpec(cfg Config) (string, error) {
	...
	options.SecureServing.ServerCert.CertDirectory = "/tmp/kubeedge-swagger"                           // Set the certificate directory.
	...
	// Create and configure the API server, creating a new API server instance named "kubeedge-openapi-server".
