...
//Below are default definitions of conf/edge.yaml, conf/logging.yaml and conf/modules.yaml
//These are used to write the respective files with necessary changes in the conf folder required by edge_core startup
var (
	EdgeYaml = []byte(`mqtt:
