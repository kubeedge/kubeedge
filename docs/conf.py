...
latex_documents = [
    (master_doc, 'KubeEdge.tex', u'KubeEdge Documentation',
     u'KubeEdge', 'manual'),
]
...
man_pages = [
    (master_doc, 'kubeedge', u'KubeEdge Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'KubeEdge', u'KubeEdge Documentation',
     author, 'KubeEdge', 'One line description of project.',
     'Miscellaneous'),
]
