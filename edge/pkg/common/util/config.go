...
// PrepareTestCerts will generate rootCA and edge certificates in /tmp directory
func PrepareTestCerts() error {
...
func GenCerts(certCfg *CertsConfig) error {
	...
	if err = WriteCertAndKey("/tmp", "rootCA", caCert, caKey); err != nil {
		return err
	}
	...
	if err = WriteCertAndKey("/tmp", "edge", kubeedgeCert, &kubeedgeKey); err != nil {
		return err
	}
