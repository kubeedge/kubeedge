...
func (c *nodes) Update(cm *api.Node) error {
	...
	nodeMsg := BuildMsg(modules.MetaGroup, "", modules.EdgedModuleName, resource, model.UpdateOperation, cm)
...
func (c *nodes) Get(name string) (*api.Node, error) {
	...
	nodeMsg := BuildMsg(modules.MetaGroup, "", modules.EdgedModuleName, resource, model.QueryOperation, nil)
