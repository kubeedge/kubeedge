...
func (c *nodes) Update(cm *api.Node) error {
	...
	nodeMsg := BuildMsg(constants.MetaGroup, "", constants.EdgedModuleName, resource, model.UpdateOperation, cm)
...
func (c *nodes) Get(name string) (*api.Node, error) {
	...
	nodeMsg := BuildMsg(constants.MetaGroup, "", constants.EdgedModuleName, resource, model.QueryOperation, nil)
