...
func dealUpdateResult(context *dtcontext.DTContext, deviceID string, eventID string, code int, err error, payload []byte) error {
	...
	return context.Send("",
		dtcommon.SendToEdge,
		dtcommon.CommModule,
		context.BuildModelMessage(constants.BusGroup, "", topic, constants.OpPublish, result))
}
...
func dealDelta(context *dtcontext.DTContext, deviceID string, payload []byte) error {
	...
	return context.Send("",
		dtcommon.SendToEdge,
		dtcommon.CommModule,
		context.BuildModelMessage(constants.BusGroup, "", topic, constants.OpPublish, payload))
}
...
func dealSyncResult(context *dtcontext.DTContext, deviceID string, baseMessage dttype.BaseMessage, twin map[string]*dttype.MsgTwin) error {
	...
	return context.Send("",
		...
		dtcommon.CommModule,
		context.BuildModelMessage("resource", "", resource, constants.OpUpdate, dttype.DeviceTwinResult{BaseMessage: baseMessage, Twin: twin}))
}
...
func DealGetTwin(context *dtcontext.DTContext, deviceID string, payload []byte) error {
	...
	return context.Send("",
		dtcommon.SendToEdge,
		dtcommon.CommModule,
		context.BuildModelMessage(constants.BusGroup, "", topic, constants.OpPublish, msg))
}
