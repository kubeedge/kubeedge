...
import (
	...
	"github.com/kubeedge/kubeedge/edge/pkg/edgegateway/internal/net"
...
// Config returns rate limit configuration for an internal rule limiting the
// number of connections per IP address and/or connections per second.
// If you both annotations are specified in a single internal rule, RPS limits
// takes precedence
type Config struct {
