...
// IngressAnnotation has a method to parse annotations located in internal
...
// GetBoolAnnotation extracts a boolean from an internal annotation
...
// GetStringAnnotation extracts a string from an internal annotation
...
// GetIntAnnotation extracts an int from an internal annotation
...
// AnnotationsReferencesConfigmap checks if at least one annotation in the internal rule
