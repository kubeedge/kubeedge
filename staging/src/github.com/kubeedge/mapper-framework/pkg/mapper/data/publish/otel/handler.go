...
const meterName = "github.com/kubeedge/mapper-framework/pkg/mapper/data/dbmethod/otel"

func DataHandler(ctx context.Context, twin *common.Twin, client driver.Adapter, visitorConfig *driver.VisitorConfig, dataModel *common.DataModel) {
