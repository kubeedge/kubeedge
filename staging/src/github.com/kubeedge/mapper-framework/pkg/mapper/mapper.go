...
import (
	...
	"github.com/kubeedge/mapper-framework/pkg/mapper/device"
)

// Run initializes the mapper and starts the necessary servers.
func Run(factory func(protocol []byte) (driver.Adapter, error)) {
	var err error
	var c *config.Config
	...
	panel := device.NewDevPanel(factory)
