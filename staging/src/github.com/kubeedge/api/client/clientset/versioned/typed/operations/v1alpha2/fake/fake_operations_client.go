...
import (
	v1alpha2 "github.com/kubeedge/api/client/clientset/versioned/typed/operations/v1alpha2"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeOperationsV1alpha2 struct {
	*testing.Fake
}
...
func (c *FakeOperationsV1alpha2) RESTClient() rest.Interface {
