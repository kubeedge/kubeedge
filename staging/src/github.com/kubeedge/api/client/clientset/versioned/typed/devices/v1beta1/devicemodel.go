...
func (c *deviceModels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.DeviceModel, err error) {
	result = &v1beta1.DeviceModel{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *deviceModels) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DeviceModelList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.DeviceModelList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("devicemodels").
...
func (c *deviceModels) Create(ctx context.Context, deviceModel *v1beta1.DeviceModel, opts v1.CreateOptions) (result *v1beta1.DeviceModel, err error) {
	result = &v1beta1.DeviceModel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("devicemodels").
...
func (c *deviceModels) Update(ctx context.Context, deviceModel *v1beta1.DeviceModel, opts v1.UpdateOptions) (result *v1beta1.DeviceModel, err error) {
	result = &v1beta1.DeviceModel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("devicemodels").
...
func (c *deviceModels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DeviceModel, err error) {
	result = &v1beta1.DeviceModel{}
