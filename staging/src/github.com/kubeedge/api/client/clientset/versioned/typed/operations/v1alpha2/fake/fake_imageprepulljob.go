...
func (c *FakeImagePrePullJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.ImagePrePullJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(imageprepulljobsResource, name), &v1alpha2.ImagePrePullJob{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeImagePrePullJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.ImagePrePullJobList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(imageprepulljobsResource, imageprepulljobsKind, opts), &v1alpha2.ImagePrePullJobList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeImagePrePullJobs) Create(ctx context.Context, imagePrePullJob *v1alpha2.ImagePrePullJob, opts v1.CreateOptions) (result *v1alpha2.ImagePrePullJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(imageprepulljobsResource, imagePrePullJob), &v1alpha2.ImagePrePullJob{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.ImagePrePullJob), err
...
func (c *FakeImagePrePullJobs) Update(ctx context.Context, imagePrePullJob *v1alpha2.ImagePrePullJob, opts v1.UpdateOptions) (result *v1alpha2.ImagePrePullJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(imageprepulljobsResource, imagePrePullJob), &v1alpha2.ImagePrePullJob{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.ImagePrePullJob), err
...
func (c *FakeImagePrePullJobs) UpdateStatus(ctx context.Context, imagePrePullJob *v1alpha2.ImagePrePullJob, opts v1.UpdateOptions) (*v1alpha2.ImagePrePullJob, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(imageprepulljobsResource, "status", imagePrePullJob), &v1alpha2.ImagePrePullJob{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.ImagePrePullJob), err
...
func (c *FakeImagePrePullJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.ImagePrePullJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(imageprepulljobsResource, name, pt, data, subresources...), &v1alpha2.ImagePrePullJob{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.ImagePrePullJob), err
