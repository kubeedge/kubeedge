...
type DeviceInformer interface {
	...
	Lister() devicesv1beta1.DeviceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DevicesV1beta1().Devices(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DevicesV1beta1().Devices(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DevicesV1beta1().Devices(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DevicesV1beta1().Devices(namespace).Watch(ctx, options)
			},
		},
		&apisdevicesv1beta1.Device{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *deviceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisdevicesv1beta1.Device{}, f.defaultInformer)
}

func (f *deviceInformer) Lister() devicesv1beta1.DeviceLister {
	return devicesv1beta1.NewDeviceLister(f.Informer().GetIndexer())
}
